...
/**
 * @extends ServiceEntityRepository<CategoryQuestion>
 *
...
class CategoryQuestionRepository extends ServiceEntityRepository
{
    ...
    public function save(CategoryQuestion $entity, bool $flush = false): void
    {
    ...
    public function remove(CategoryQuestion $entity, bool $flush = false): void
    {
